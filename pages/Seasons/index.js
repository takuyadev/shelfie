  ...
  return (
    ...
    >
      ...
      <main>
        ...
        <p class="infoText">The types of produce that are avaiable vary depending on the time of year. Select a season to view produce that are commonly grown, and sold in Canada during that season.</p>
